...
------------------------------------------------------------
IF OBJECT_ID('dbo.sp_report_sessions','P')      IS NOT NULL DROP PROCEDURE dbo.sp_report_sessions;
IF OBJECT_ID('dbo.sp_report_workload','P')      IS NOT NULL DROP PROCEDURE dbo.sp_report_workload;
IF OBJECT_ID('dbo.sp_report_integrity','P')     IS NOT NULL DROP PROCEDURE dbo.sp_report_integrity;
IF OBJECT_ID('dbo.sp_report_flight','P')        IS NOT NULL DROP PROCEDURE dbo.sp_report_flight;
IF OBJECT_ID('dbo.sp_report_window','P')        IS NOT NULL DROP PROCEDURE dbo.sp_report_window;
IF OBJECT_ID('dbo.sp_calc_metrics','P')         IS NOT NULL DROP PROCEDURE dbo.sp_calc_metrics;
IF OBJECT_ID('dbo.sp_calc_sessions','P')        IS NOT NULL DROP PROCEDURE dbo.sp_calc_sessions;
IF OBJECT_ID('dbo.sp_infer_work_calendar','P')  IS NOT NULL DROP PROCEDURE dbo.sp_infer_work_calendar;
IF OBJECT_ID('dbo.sp_load_client_data','P')     IS NOT NULL DROP PROCEDURE dbo.sp_load_client_data;
